            ...
            <div class="col-lg-3 col-md-4">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2">
                        ...
                        Myanma Gon Yi Street, FLP Building A, Tharketa
                    </li>
                    <li class="mb-2">
            ...
            <div class="col-md-6 text-center text-md-end">
                <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                        <a href="privacy.php" class="text-white-50 small">Privacy Policy</a>
                    </li>
                    <li class="list-inline-item">
                        <a href="FAQ.php" class="text-white-50 small">FAQ</a>
                    </li>
                    <!-- <li class="list-inline-item">
